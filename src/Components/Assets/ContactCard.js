const ContactCard = ({ icon, title, info_one, info_two }) => {
  return <div className="grid items-center rounded-md p-2 w-[45vw] md:p-5  md:w-48 aspect-square bg-accent hover:bg-primary text-primary hover:text-accent font-work">
