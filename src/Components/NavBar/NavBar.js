...
const NavBar = () => {
  ...
  return (
    <header>
        ...
        <article id="h-bottom" className='bg-primary w-full flex justify-around items-center py-5'>
            ...
            <div id='nav-side' className='flex gap-5 items-center'>
                <div className="search flex items-center gap-2">
                    {
                        search ? <input type="search" className='rounded-full py-1.5 px-3 font-work text-sm outline-none' placeholder='Search...'/> : null
                    }
                ...
                <button id="appoint-btn" className='bg-accent px-8 py-1.5 capitalize text-primary rounded-full font-semibold'>
                    appointment
                </button>
            </div>
        </article>
